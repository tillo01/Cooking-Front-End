    ...
    <div className="order-page">
      <Container className="order-container">
        <Stack className="order-big-box">
          ...
          <Stack className="right-user-box" gap={4}>
                ...
                <Box className="member-box">
                  <div className="order-user-img">
                    ...
                    <div className="order-user-icon-box">
                      <img src={"/icons/user-badge.svg"} className="order-user-prof-img" alt="" />
                    </div>
                  </div>
            ...
            <Stack className="order-right">
              <Stack className="order-right-inputs" gap={2}>
                <Box>
                  <input className="card-input" type="text" placeholder="Card number : 5243 4090 2002 7495" />
                </Box>
                ...
                <Box>
                  <input className="card-input" type="text" placeholder="Justin Roberston" />
                </Box>
